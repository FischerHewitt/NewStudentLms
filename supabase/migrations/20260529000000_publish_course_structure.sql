-- Transactional Course structure persistence.
-- Publishes a reviewed Course structure by inserting Modules, Assignments,
-- Rubrics, and Enrollment before clearing courses.generation_preview.
...
comment on function publish_course_structure(uuid, uuid, uuid, jsonb) is
  'Publishes a reviewed Course structure transactionally: Modules, Assignments, Rubrics, Enrollment, then clears generation_preview.';
